...
const LEGENDS = [
  {
    ...
    stat: "630 career HR",
    hof: "2016 · 99.3%",
    blurb: "The sweetest swing in the history of the game. He made it look like play. He made the game look like it was invented for him. And then the front office couldn't hold onto him. He came back anyway for one last year at 39. He's our guy forever.",
  },
  {
    id: 118800,
    name: "Edgar Martinez",
    ...
    stat: ".312 career AVG",
    hof: "2019 · 85.4%",
    blurb: "The greatest designated hitter in baseball history — so great they named the DH award after him. 'The Double' in 1995 is the defining play in franchise history. He played his entire 18-year career as a Mariner. That kind of loyalty is essentially extinct.",
  },
  {
    id: 400085,
    name: "Ichiro Suzuki",
    ...
    hof: "2025 · 99.7%",
    blurb: "The most precise baseball player who has ever lived. He had a ritual — adjusting his batting gloves, tugging his sleeve, the exact same way, every single time — and it looked like a samurai preparing for battle. Add his Japanese stats and it's 4,300+ hits. He is not human.",
  },
  {
    id: 122493,
    name: "Randy Johnson",
    ...
    stat: "308 K in 1993",
    hof: "2015 · 97.3%",
    blurb: "6'10\" of pure, barely-controlled chaos. He once accidentally killed a bird with a fastball. KILLED. A. BIRD. He figured out command around 1993 and became unhittable. Then we traded him. He won a World Series and multiple Cy Youngs after leaving. Nailed it.",
  },
  {
    id: 433587,
    ...
    hof: "Eligible 2025",
    blurb: "Gave the best years of his prime to teams that never deserved him. Could've left for a contender a dozen times. Didn't. Threw a perfect game for a team that went 75-87. Won a Cy Young at 13-12. He deserved a World Series ring and got mediocrity in return. We owe him a debt we can't repay.",
  },
];
...
const BAD_TRADES = [
  {
    ...
    consequence: "Derek Lowe won Game 7 of the 2004 World Series for Boston. Jason Varitek captained that dynasty for a decade. Heathcliff Slocumb had a 5.32 ERA as a Mariner. This is widely considered one of the worst trades in baseball history and nothing will convince me otherwise.",
  },
  {
    pain: 10,
    year: "2000",
    ...
    consequence: "Griffey wanted out. There were ways to keep him. The M's sent the greatest player in franchise history — the player who SAVED baseball in Seattle in 1995 — for Mike Cameron and prospects. We could have kept him. We didn't. We live with that.",
  },
  {
    pain: 8,
    year: "1995",
    ...
    consequence: "Tino went on to help the Yankees win four World Series titles. Russ Davis hit .237. Sterling Hitchcock was fine. The Yankees used our guy to build a dynasty while we watched from home every October for 21 years.",
  },
  {
    pain: 8,
    year: "1998",
    ...
    consequence: "Randy went to Houston, then Arizona, where he won the World Series and another Cy Young. Garcia was genuinely good — maybe this one's not as bad. Still, trading a future Hall of Famer is never ideal. Freddy Garcia wasn't Randy Johnson. Nobody was.",
  },
  {
    pain: 7,
    year: "2004",
    ...
    gave: "Carlos Guillen",
    got: "Ramon Santiago",
    consequence: "Guillen became a perennial All-Star in Detroit. Santiago was... a backup infielder. At the time it seemed like cap flexibility. In retrospect, another guy who got better after we let him go.",
  },
];
    ...
    <div className="space-y-24 pb-16">
            ...
            {TIMELINE.map((item, i) => {
              ...
              return (
                <RevealSection key={`${item.year}-${i}`} delay={0}>
                  <div className={cn("relative flex items-start gap-6 sm:gap-0", isRight ? "sm:flex-row" : "sm:flex-row-reverse")}>
                    {/* Dot */}
                    <div className="absolute left-4 sm:left-1/2 top-3 w-3 h-3 rounded-full border-2 border-bg-deep sm:-translate-x-1.5 -translate-x-1.5 z-10 flex-shrink-0"
                      style={{}}
                    >
                    ...
                    <div className={cn(
                      ...
                      <div className={cn(
                        "trident-card p-4 border transition-colors",
                        vc.card
                      )}>
                        <div className={cn("flex items-center gap-2 mb-2", isRight ? "sm:flex-row-reverse sm:justify-start" : "")}>
                          <span className="text-xl">{item.icon}</span>
                          <div>
                            <span className="text-xs font-black text-teal">{item.year}</span>
                            <span className="text-[9px] text-muted ml-2 uppercase tracking-widest font-bold">{vc.label}</span>
                          </div>
                        </div>
      ...
      <div>
        <RevealSection>
          <SectionHeader
            title="The Moments"
            subtitle="The plays you still see when you close your eyes"
          />
        </RevealSection>
      ...
      <div>
        <RevealSection>
          <SectionHeader
            title="Wait, What?"
            subtitle="Facts so absurd they feel made up. They are not."
          />
        </RevealSection>
